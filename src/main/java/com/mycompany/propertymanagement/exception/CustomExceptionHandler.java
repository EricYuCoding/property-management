...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<List<ErrorModel>> handleBusinessException(BusinessException bex){
        for (ErrorModel em: bex.getErrors()){
            logger.debug("Inside BusinessException: - level- debug: {} - {}", em.getCode(), em.getMessage());
            logger.info("Inside BusinessException: - level- info: {} - {}", em.getCode(), em.getMessage());
            logger.warn("Inside BusinessException: - level- warn: {} - {}", em.getCode(), em.getMessage());
            logger.error("Inside BusinessException: - level- error: {} - {}", em.getCode(), em.getMessage());
        }
